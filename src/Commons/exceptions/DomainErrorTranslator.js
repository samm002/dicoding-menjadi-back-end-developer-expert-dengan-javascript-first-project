...
DomainErrorTranslator._directories = {
  ...
  'CREATE_REPLY_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat reply comment baru karena properti yang dibutuhkan tidak ada'),
  'CREATE_REPLY_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat reply comment baru karena tipe data tidak sesuai'),
}
